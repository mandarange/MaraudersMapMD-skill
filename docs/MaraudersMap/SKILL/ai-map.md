...
| Procedure | 48-654 | 4257 | Follow these five phases in order. Each phase uses a MaraudersMapMD artifact as its primary reference. |
| Checklist | 655-683 | 399 | After rewriting, verify every item below. Each maps to a rule in the canonical prompt. |
