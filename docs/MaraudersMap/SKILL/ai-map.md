...
| Procedure | 48-667 | 4575 | Follow these five phases in order. Each phase uses a MaraudersMapMD artifact as its primary reference. |
| Checklist | 668-701 | 486 | After rewriting, verify every item below. Each maps to a rule in the canonical prompt. |
